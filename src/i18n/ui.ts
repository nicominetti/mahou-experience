...
export const ui = {
	en: {
		...
		services: "Services",
		homepage: "Homepage",
		tagline: "Crea tu camiseta única y exclusiva con nuestra revolucionaria herramienta de personalización 3D. Materiales premium de primera calidad, diseñadas para el máximo confort y durabilidad, completamente gratis para nuestros invitados VIP. Libera tu creatividad y define tu estilo personal en el icónico Santiago Bernabéu.",
		"services.design.title": "Diseño Personalizado",
		"services.design.content": "Usa nuestro editor interactivo para crear diseños únicos. Añade texto, cambia colores y ve tu creación en tiempo real.",
		"services.quality.title": "Alta Calidad",
		"services.quality.content": "Utilizamos materiales premium y técnicas de impresión avanzadas para garantizar que tu camiseta luzca perfecta.",
		"services.fast.title": "Entrega Rápida",
		"services.fast.content": "Procesamos tu pedido en 24 horas y lo producimos en 3-5 días hábiles con envío gratuito.",
		"services.support.title": "Soporte Completo",
		"services.support.content": "Te acompañamos desde el diseño hasta la entrega, asegurando que tengas la mejor experiencia posible.",
		"projects.yours": "Your project",
		"projects.see": "See project",
		"hero.title.main": "Mahou Experience",
		"hero.title.1": "Experiencia vip",
		"hero.title.2": "Exclusivo Bernabéu",
		"hero.subtitle": "Diseña tu camiseta única en el corazón del Santiago Bernabéu. Una experiencia exclusiva y completamente gratuita para ti.",
		"hero.scroll": "explora más abajo",
		"hero.cta": "Diseña tu Camiseta",
		"personaliza.title": "Personaliza",
		"model3d.title": "Visualiza en 3d",
		"delivery.title": "Recíbela gratis",
		"seo.title": "LET'S DO IT.",
		"advertising.title": "Advertising",
		"personaliza.content": "Elige tu talla ideal y coloca el logotipo de Mahou donde más te guste. Puedes elegir varios lugares donde colocar el logo.",
		"model3d.content": "Disfruta de nuestro modelo 3D interactivo con rotación 360° en tiempo real para asegurarte dónde irá el logo.",
		"delivery.content": "Tu camiseta personalizada llegará a casa en 24-48 horas sin coste adicional.",
		"seo.content": "Materiales premium de primera calidad, diseñadas para el máximo confort y durabilidad, completamente gratis para nuestros invitados VIP. Libera tu creatividad y define tu estilo personal en el icónico Santiago Bernabéu.",
