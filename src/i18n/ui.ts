...
export const ui = {
	en: {
		...
		"websites.title": "Personaliza",
		"apps.title": "Visualiza en 3d",
		"uiux.title": "Recíbela gratis",
		"seo.title": "LET'S DO IT.",
		"advertising.title": "Advertising",
		"websites.content": "Elige tu talla ideal y coloca el logotipo de Mahou donde más te guste. Puedes elegir varios lugares donde colocar el logo.",
		"apps.content": "Disfruta de nuestro modelo 3D interactivo con rotación 360° en tiempo real para asegurarte dónde irá el logo.",
		"uiux.content": "Tu camiseta personalizada llegará a casa en 24-48 horas sin coste adicional.",
